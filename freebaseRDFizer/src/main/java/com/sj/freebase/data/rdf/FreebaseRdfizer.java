...
public class FreebaseRdfizer implements ExtDataTransformer<List<StringBuffer>>{
	...
	public static void main (String [] args) throws Exception {
		...
		FreebaseRdfizer.display (rdfizer.transformData("/m/0p_47\t/film/actor/film\t/m/02vcwc8"));
		FreebaseRdfizer.display (rdfizer.transformData("/m/0p_47	/film/actor/film	/m/02vcwc8"));
		FreebaseRdfizer.display (rdfizer.transformData("/m/0p_47\t/people/person/height_meters\t\tC\\C (シンデレラ\\コンプレックス)"));
		FreebaseRdfizer.display (rdfizer.transformData("/m/01hf9dc\t/type/object/name\t\t\"Don`t Shoot Me I`m Only the Piano Player\""));
		FreebaseRdfizer.display (rdfizer.transformData("/m/0p_47\t/type/object/name\t/lang/en\tSteve Martin"));
		FreebaseRdfizer.display (rdfizer.transformData("/m/0p_47\t/type/object/key\t/wikipedia/pt\tSteve_Martin"));
		FreebaseRdfizer.display (rdfizer.transformData("/m/0p_47\t/type/object/name\t/lang/en\tSteve'Martin"));
		FreebaseRdfizer.display (rdfizer.transformData("/m/0p_47\t/type/object/name\t/lang/en\tSteve\"Martin"));
		FreebaseRdfizer.display (rdfizer.transformData("/m/063q09g	/freebase/labs_project/publicized_date		2009-06-04"));
		
		FreebaseRdfizer.display (rdfizer.transformData("/m/026jl_d\t/type/object/name\t/guid/9202a8c04000641f8000000004684bec\t\"2004-11-22\""));
